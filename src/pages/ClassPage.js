...
import Class8Slides from '../components/classes/class-8/Slides';
import Class9Slides from '../components/classes/class-9/Slides';
import Class10Slides from '../components/classes/class-10/Slides';
import Class11Slides from '../components/classes/class-11/Slides';
import Class12Slides from '../components/classes/class-12/Slides';
import Class13Slides from '../components/classes/class-13/Slides';
import Class14Slides from '../components/classes/class-14/Slides';
import Class15Slides from '../components/classes/class-15/Slides';
import Class18Slides from '../components/classes/class-18/Slides';
import Class19Slides from '../components/classes/class-19/Slides';
import Class20Slides from '../components/classes/class-20/Slides';
...
const ClassPage = () => {
  ...
  if (classNum === 10) {
    return <Class10Slides />;
  }
  
  if (classNum === 11) {
    return <Class11Slides />;
  }
  
  if (classNum === 12) {
    return <Class12Slides />;
  }
  
  if (classNum === 13) {
    return <Class13Slides />;
  }
  
  if (classNum === 14) {
    return <Class14Slides />;
  }
  
  if (classNum === 15) {
    return <Class15Slides />;
  }
  
  if (classNum === 18) {
    return <Class18Slides />;
  }
  
  if (classNum === 19) {
    return <Class19Slides />;
  }
  
  if (classNum === 20) {
    return <Class20Slides />;
  }
