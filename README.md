...
Everything here is structured to support your success, and I want you to feel confident and excited about what you're building! 🎯
...
**Weekly Homework (35%)**: These assignments reinforce class concepts through hands-on practice. They're designed to help you grow and are genuinely approachable if you put in the effort. You can use any learning resources to understand the material, but please avoid copy-pasting from AI tools – you'll learn so much more by writing the code yourself!

**Mini-Projects (25%)**: These come at key learning moments and focus on bringing concepts together. Feel free to use AI tools for brainstorming and problem-solving – these projects are about integration, planning, and creativity.
...
✅ **Build Modern React Applications** with components, state, and routing  
...
✅ **Apply Modern Development Practices** like responsive design and error handling  
...
*Questions about the course? Check out our FAQ section or reach out during office hours. Welcome to CS390 – your gateway to full-stack web development!*
